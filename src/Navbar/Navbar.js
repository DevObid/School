...
function Navbar() {
    return (
        ...
        <div className="navbar flex justify-between items-center bg-base-100 bg-white w-full h-14">
            ...
            <button type="button" className="text-gray-900 font-medium        w-9 h-9 p-1  rounded-full  ring-gray-300 dark:ring-gray-500        flex justify-center items-center  absolute right-20   border-gray-300 focus:outline-none bg-gray-100  focus:ring-4 focus:ring-gray-100 text-[22px]  dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
